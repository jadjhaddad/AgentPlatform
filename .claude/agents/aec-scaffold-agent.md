...
description: Scaffolds Revit, Civil 3D, CSi, Dynamo, and COM plugin projects via the aec-scaffold-mcp server. Use when creating a new plugin project or upgrading an existing one.
tools:
  - mcp__aec-scaffold-mcp__health_check
  - mcp__aec-scaffold-mcp__list_templates
  - mcp__aec-scaffold-mcp__get_template_info
  - mcp__aec-scaffold-mcp__scaffold_project
  - mcp__aec-scaffold-mcp__upgrade_project
  - mcp__aec-scaffold-mcp__deploy_project
---
